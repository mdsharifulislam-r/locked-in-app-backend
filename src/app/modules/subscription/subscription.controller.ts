...
const getSubscription = catchAsync(async (req: Request, res: Response) => {
  const subscription = await SubscriptionService.getSubscriptionByUser((req.user as any), req.query);
  const response = {
    success: true,
    message: "Subscription created successfully",
    data: subscription,
...
const getSubscriberPackages = catchAsync(async (req: Request, res: Response) => {
  const subscription = await SubscriptionService.getSubscriptionByUser((req.user as any), req.query);
  const response = {
    success: true,
    message: "Subscription created successfully",
